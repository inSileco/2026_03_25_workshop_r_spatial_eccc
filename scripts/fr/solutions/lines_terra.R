...
# ------------------------------------------------------------
# 6) Mesurer la longueur des trajets et la distance à la côte
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# 7) Joindre les trajets aux habitats
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# 8) Résumés à partir du chevauchement vectoriel
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# 10) Exploration rapide du raster
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# 11) Projeter et rogner le raster
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# 12) Extraire la bathymétrie le long des trajets et des segments
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# 14) Analyse avancée : GLM sur les segments de ligne
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# 15) Analyse avancée : KDE sur les points de télémétrie
# ------------------------------------------------------------
